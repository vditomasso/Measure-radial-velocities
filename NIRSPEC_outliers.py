...
def main(argv=None):
    ...
    rv_meas, rv_meas_err = find_rv_outliers.radial_velocity(numpy.asarray(obj_wave), numpy.asarray(obj_flux),
                                                   numpy.asarray(obj_flux) / 10., numpy.asarray(std[0]),
                                                   numpy.asarray(std[1]), numpy.asarray(std[1]) / 10., starname_obj,
                                                   starname_std, rv_std, rv_std_err, order_obj, xcorr_width, cut,
                                                   cutstart, cutend)
